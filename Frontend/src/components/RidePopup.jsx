...
const RidePopup = (props) => {
  return (
    <div>
        ...
        className='w-full mt-3 bg-green-600 text-white font-semibold p-2 rounded-lg'>Accept</button>
       <button onClick={() => props.setRidePopupPanel(false)}
        className='w-full mt-2 bg-gray-300 text-gray-800 font-semibold p-2 rounded-lg'>Ignore</button>
