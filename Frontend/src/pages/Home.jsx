...
const Home = () => {
  return (
    <div>
      <div className='bg-cover bg-center bg-[url(https://cn-geo1.uber.com/image-proc/crop/resizecrop/udam/format=auto/width=672/height=672/srcb64=aHR0cHM6Ly90Yi1zdGF0aWMudWJlci5jb20vcHJvZC91ZGFtLWFzc2V0cy80MmEyOTE0Ny1lMDQzLTQyZjktODU0NC1lY2ZmZmUwNTMyZTkucG5n)] h-screen w-full pt-8 bg-red-400 flex justify-between flex-col'>
